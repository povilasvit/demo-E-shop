...
const shopContainer = document.querySelector('.shopCateoryContainer');
...
function scrollToShopp(){
	let shopContainerPosition = shopContainer.getBoundingClientRect();
	let topPosition = shopContainerPosition.top;
	let documentScrollTop = document.documentElement.scrollTop;
	window.scrollTo({
		top: topPosition + documentScrollTop - 0.1 * (topPosition + documentScrollTop),
		behavior: "smooth"
	});
}
...
// ********************** Contact Us  Validation  *******************************
// ********************** Contact Background Height  *******************************

const contactContainer = document.querySelector('.contactContainer');

window.addEventListener('load', function(){
	contactContainer.style.minHeight = window.innerHeight + 'px';
});

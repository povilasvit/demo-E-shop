				...
				@csrf
					<div class="checkoutWrapper">
						...
						<div class="payment">
							...
							<div class="visaMastercardLogo">
								<img src="images/VISA-logo.png">
								<img src="images/Mastercard-Logo.png">
							</div>
							<p class="paymentDetails">The Payment GateWay is in test mode. You can use only Stripe testing card number and cvc (card number: 4242 4242 4242 4242; exp. date - any future date; cvc: 123)</p>

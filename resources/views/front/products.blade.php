...
@section('content')
		...
		<div class="shopCateoryContainer" id="container">
			<h3 class="categoryHeader">
				{{!empty($cat) ? $cat->name : 'Visos prekės'}}
			</h3>
					...
					@foreach($products as $product)
						@if($product->inStock > 0)
							@if($product->discount->value !== 0)
								<div class="products">
									<a href="{{route('singleProduct', $product->slug)}}#container" class="productImg" ><img src="/images/products/{{$product->path}}"></a>
									<a href="{{route('singleProduct', $product->slug)}}#container" class="productText"><h3>{{$product->name}}</h3></a>
									...
									<div class='btn'>
										...
										<a href="{{route('singleProduct', $product->slug)}}#container" class="btnProductMore btnProductInfo">

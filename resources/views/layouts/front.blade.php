...
<body>
	<main>
		<div class="header">
			<nav>
				<div class="navi">
					@if(request()->routeIs('frontHome') || request()->routeIs('webcategory') || request()->routeIs('allProducts'))
						<a class="nav navActive">E-Parduotuvė</a>
					@else
						<a href="{{route('frontHome')}}#container" class="nav navActive">E-Parduotuvė</a>
					@endif	
			...
			<div class="navText">
				...
				@else
					<a href="{{ route('frontHome')}}#container" class="agoToShop">
		...
		<footer>
			<div class="footerPrimary">
				...
				<div class="section2">
					...
					<div><a href="{{route('shipping')}}#container">Pristatymas</a></div>
					<div><a href="{{route('return_and_replacement')}}#container">Grąžinimas</a></div>
					<div><a href="{{route('privacy')}}#container">Privatumo Politika</a></div>
				</div>
				<div class="section3">
					<div><h3>Kontaktai</h3></div>
					<div><i class="fas fa-phone"></i> +37065528918</div>
					<div><i class="fas fa-envelope-square"></i> info@pvit.com</div>
					<div><a href="https://www.facebook.com/povilas.vitkauskas"><i class="fab fa-facebook-f"></i> Povilas Vitkauskas</a></div>
					<div><a href="https://www.instagram.com/povilasvitkauskas/"><i class="fab fa-instagram"></i> Povilas Vitkauskas</a></div>
				</div>
			</div>
		</footer>
